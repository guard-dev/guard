...
export const IconCloudSecurity: React.FC<IconProps> = ({ className }) => (
...
export const IconRealTime: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const IconActionable: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
